...
all:
	...
	g++ main.o MyString.o MyFunc.o StrncpyTesting.o StrcatTesting.o StrchrTesting.o StrcmpTesting.o StrcpyTesting.o StrdupTesting.o StrlenTesting.o StrncatTesting.o FgetsTesting.o
